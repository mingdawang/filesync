...
use crate::app::{dialogs, strings, support, CloseDialogAction, FileSyncApp};
...
impl eframe::App for FileSyncApp {
    ...
    fn update(&mut self, ctx: &egui::Context, _frame: &mut eframe::Frame) {
        ...
        handle_close_requests(self, ctx);
        apply_theme(self, ctx);
        self.drain_events();
        self.drain_preview();
        ...
        render_progress_panel(self, ctx);
        render_job_list_panel(self, ctx);
        render_main_panel(self, ctx);
...
fn apply_theme(app: &FileSyncApp, ctx: &egui::Context) {
...
fn handle_close_requests(app: &mut FileSyncApp, ctx: &egui::Context) {
...
fn render_top_panel(app: &mut FileSyncApp, ctx: &egui::Context) {
...
fn render_progress_panel(app: &mut FileSyncApp, ctx: &egui::Context) {
...
fn render_job_list_panel(app: &mut FileSyncApp, ctx: &egui::Context) {
...
fn render_main_panel(app: &mut FileSyncApp, ctx: &egui::Context) {
    egui::CentralPanel::default().show(ctx, |ui| {
        job_editor::show(ui, app);
    });
}

fn render_settings_window(app: &mut FileSyncApp, ctx: &egui::Context) {
...
fn render_about_window(app: &mut FileSyncApp, ctx: &egui::Context) {
    if !app.about_open {
        return;
    }
